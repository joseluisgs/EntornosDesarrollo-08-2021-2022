...
public class PaisView {
    ...
    // private final PaisController paisController = PaisController.getInstance(new PaisRepository());
    private final PaisController paisController = new PaisController(new PaisRepository());
    ...
    public void menu() {
        ...
        do {
            ...
            System.out.println();
            String opcion = Console.getString("Elige una opción [1-7]: ");
