...
DROP DATABASE IF EXISTS `dam`;
CREATE DATABASE `dam` /*!40100 DEFAULT CHARACTER SET utf8mb3 */;
USE `dam`;
...
INSERT INTO `acuerdo` (`id`, `nombre`, `fecha`, `aportacion`) VALUES
                                                                  (1,	'Acuerdo Diplomático',	'2022-03-25 20:59:57',	12345.89),
...
INSERT INTO `linea_acuerdo` (`id_acuerdo`, `id_pais`, `año`, `subvencion`) VALUES
                                                                               (1,	1,	2022,	1234.56),
                                                                               (1,	2,	2022,	345.32),
                                                                               (2,	4,	2022,	450.8),
                                                                               (2,	7,	2022,	6666.66),
...
INSERT INTO `pais` (`id`, `nombre`, `codigo`, `idioma`, `moneda`, `capital`, `presupuesto`) VALUES
                                                                                                (1,	'España',	'ES',	'Español',	'Euro',	'Madrid',	1234567.23),
