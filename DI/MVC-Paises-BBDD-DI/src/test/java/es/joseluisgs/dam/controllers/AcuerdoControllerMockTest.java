...
class AcuerdoControllerMockTest {
    ...
    void createAcuerdo() throws SQLException {
        ...
        when(acuerdoRepository.save(any(Acuerdo.class))).thenReturn(acuerdoTest);
    ...
    void deleteAcuerdo() throws SQLException {
        when(acuerdoRepository.delete(1)).thenReturn(acuerdoTest);
    ...
    void updateAcuerdo() throws SQLException {
        when(acuerdoRepository.update(acuerdoTest.getId(), acuerdoTest)).thenReturn(acuerdoTest);
